...
const ClientCardComp = () => {
  ...
  return (
    <>
      ...
      <section className="w-full h-screen mb- mt-12 " id="testimonial">
        <div className="glide-01 absolute w-full py-10 h- ">
          <Partners name="What Our Clients Saying?" />
          <div className="absolute left-0 flex h-0 w-full items-center justify-between px-4 ">
            <img src={semicolon} alt="" className="h-5 lg:h-10 " />
            <img src={semicolon2} alt="" className="h-5 lg:h-10" />
            <img
              src={circle}
              alt=""
              className=" lg:top-56 lg:visible invisible left-0 lg:right-[4rem] absolute lg:h-[30rem] lg:w-[16rem] "
            />
          </div>

          {/*    <!-- Slides --> */}
          <div className="overflow-hidden mb-" data-glide-el="track">
            <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0 ">
              <li className="bg-transparent border-solid border-black ">
                <Cards
                  img2={clientimg}
                  heading="Alan Marti"
                  star={
              ...
              <li className=" border-solid   shadow-2xl ">
                <Cards
                  img2={clientimg}
