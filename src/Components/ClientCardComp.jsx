...
const ClientCardComp = () => {
  ...
  return (
    <>
      ...
      <div className="glide-01 absolute w-full p-20">
        ...
        {/*    <!-- Slides --> */}
        <div className="overflow-hidden bg-transparent" data-glide-el="track">
          <ul className="whitespace-no-wrap flex-no-wrap [backface-visibility: hidden] [transform-style: preserve-3d] [touch-action: pan-Y] [will-change: transform] relative flex w-full overflow-hidden p-0 ">
            ...
            <li className="bg-bue-600 border-solid border-r-2 border-t-4 shadow-2xl border-black ">
              <Cards
                roundedimg={clientimg}
