              ...
              <div className="col-span-4 md:col-span-8 lg:col-span-12">
                <section>
                  <div className="container px-6 m-auto">
                    <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12  justify-between">
                      <div className="col-span-4 lg:col-span-6  ml-20">
                        <h2 className=" text-xl font-semibold font-poppins text-[#BC384A]">
                          NEWSLETTER
                        </h2>
                        <h1 className=" mb-3 text-4xl font-bold font-poppins text-[#333333]">
                          Got A Project For Us?
                        </h1>
                        <p className=" text-base font-medium font-poppins text-[#272726]  w-[30vw]">
                          Lorem, ipsum dolor sit amet consectetur adipisicing
                          elit. Molestias non quasi, tempore deleniti
                        </p>
                      </div>
                      <div className="col-span-4 lg:col-span-6  flex justify-end items-center pr-8">
                        <Button
