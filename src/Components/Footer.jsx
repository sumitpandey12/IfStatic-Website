      ...
      <footer className="bg-[#333333] ">
        ...
        <div className="mx-auto max-w-screen-2xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24 ">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
            ...
            <div className="grid grid-cols-1 gap-20 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  <li>
                    ...
                    >
                      <svg
                        ...
                        className="h-5 w-5 shrink-0 text-[#ffffff]"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        strokeWidth="2"
                      ...
                      <span className="flex-1 text-[#ffffff]">
                        sumit@gmail.com
                      </span>
                    </a>
                  </li>
                  ...
                  <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                    ...
                    <address className="-mt-0.5 flex-1 not-italic text-[#ffffff]">
                      A57/33, Sulabh Awas, GomtiNagar Extenstion, Lucknow,
                      226010, India
                    </address>
                  </li>
                </ul>
